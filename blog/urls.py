...
from blog.views import (
    CategoryPostView, CategoryListView, IndexView,
    PostDetailView, SearchPostView, TagListView, TagPostView,
    CommentFormView, comment_approve, comment_remove,
    ReplyFormView, reply_approve, reply_remove, )

app_name = 'blog'
urlpatterns = [
    path('', IndexView.as_view(), name='index'),
    path('post/<int:pk>/', PostDetailView.as_view(), name='post_detail'),
    path('categorise/', CategoryListView.as_view(), name='category_list'),
